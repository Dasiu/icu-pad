package com.icupad.default_test_type.service.handler;

import com.icupad.hl7_gateway.domain.TestMapping;
import com.icupad.hl7_gateway.domain.TestType;
import com.icupad.hl7_gateway.service.hl7_server.handler.test_group_handler.AbstractTestTypeHandler;
import com.icupad.hl7_gateway.service.hl7_server.handler.test_group_handler.TestTypeHandler;
import com.icupad.default_test_type.domain.*;
...
public class DefaultTestTypeHandler
    ...
    @Override
    protected Pair<TestRequest, com.icupad.hl7_gateway.domain.TestResult>
    toSpecificTestRequestType(Pair<com.icupad.hl7_gateway.domain.TestRequest,
        ...
        com.icupad.hl7_gateway.domain.TestRequest testRequest = requestAndResult.getLeft();
    ...
    private TestResult createTestResult(com.icupad.hl7_gateway.domain.TestResult generalTestResult) {
    ...
    private TestRequest createTestRequest(com.icupad.hl7_gateway.domain.TestRequest testRequest) {
    ...
    private Test findTest(com.icupad.hl7_gateway.domain.TestRequest testRequest) {
