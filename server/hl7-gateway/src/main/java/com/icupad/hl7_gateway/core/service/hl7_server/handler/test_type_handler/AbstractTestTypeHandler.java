...
public abstract class AbstractTestTypeHandler<TestRequest, TestResult, TestPanelResult> {
    public void handle(Collection<Pair<com.icupad.hl7_gateway.core.domain.TestRequest,
            com.icupad.hl7_gateway.core.domain.TestResult>> testRequestsAndResults) {
    ...
    protected abstract Pair<TestRequest, com.icupad.hl7_gateway.core.domain.TestResult>
