package com.icupad.test_results.default_test_type.config;
...
@EnableJpaAuditing
@EnableJpaRepositories(value = {"com.icupad.test_results.default_test_type.repository", "com.icupad.repository"},
